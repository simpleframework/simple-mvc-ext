...
public class SyntaxHighlighterRegistry extends AbstractComponentRegistry {
	...
	@Override
	public SyntaxHighlighterBean createComponentBean(final PageParameter pp,
			final Object attriData) {
		final SyntaxHighlighterBean syntaxHighlighter = (SyntaxHighlighterBean) super.createComponentBean(
				pp, attriData);

		final String beanId = syntaxHighlighter.hashId();
		final String ajaxRequest = "ajaxRequest_" + beanId;
		pp.addComponentBean(ajaxRequest, AjaxRequestBean.class)
